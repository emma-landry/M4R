...
```{r}&;
lm1 <- stan_lm(Medians ~ Trump + Hes, data = matrix1, prior = R2(0.5, what = "mean"))
lm2 <- stan_lm(Medians ~ Trump + Strong_Hes, data = matrix1, prior = R2(0.5, what = "mean"))
lm3 <- stan_lm(Medians ~ Trump, data = matrix1, prior = R2(0.5, what = "mean"))
...
lm6 <- stan_lm (Medians ~ Trump+ Hes + Strong_Hes , data = matrix1, prior = R2(0.5, what = "mean"))
```
